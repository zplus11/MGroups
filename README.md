...
The package is well documented in the documentation center of Mathematica, furthermore you can also interactively explore it using a single notebook available at [MGroups.nb](MGroups.nb).
